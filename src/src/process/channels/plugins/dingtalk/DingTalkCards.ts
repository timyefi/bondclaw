...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'BondClaw Assistant',
    text: '### BondClaw Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      '### Pairing Required',
      '',
      'Please pair your account with BondClaw:',
      '',
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      '1. Open BondClaw settings',
...
export function createPairingStatusCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      ...
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      'Please approve in BondClaw settings:',
      '1. Open BondClaw app',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'BondClaw Assistant Help',
    text: [
      '### BondClaw Assistant Help',
      '',
      'A remote assistant to interact with BondClaw via DingTalk.',
      '',
      '**Common Actions:**',
