...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/timyefi/bondclaw/discussions/1326';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/timyefi/bondclaw/discussions/1325';
