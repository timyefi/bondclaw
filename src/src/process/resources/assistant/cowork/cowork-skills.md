...
triggers: create skill, new skill, skill template, define skill, 创建技�? 新技�?
---
...
triggers: PowerPoint, presentation, .pptx, slides, slide deck, pitch deck, ppt, slideshow, deck, keynote, 演示文稿, 幻灯�?
---
...
triggers: complex task, multi-step, plan, organize, breakdown, orchestrate, project plan, workflow, 任务规划, 多步�?
---
