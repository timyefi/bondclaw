...
export interface IStartOnBootStatus {
  ...
  supported: boolean;
  /** Whether BondClaw is currently configured to launch at login */
  enabled: boolean;
...
export const fs = {
  ...
  // Skills Market: inject/remove the skills builtin skill (legacy name preserved for compat)
...
export const deepLink = {
  /** Emitted when app is opened via bondclaw:// protocol URL */
...
export const bondclaw = {
  getRuntimeState: bridge.buildProvider<import('@/common/config/bondclawRuntimeState').BondClawRuntimeSnapshot, void>(
    'bondclaw.get-runtime-state'
  ),
  refreshRuntimeState: bridge.buildProvider<
    import('@/common/config/bondclawRuntimeState').BondClawRuntimeSnapshot,
    void
  >('bondclaw.refresh-runtime-state'),
  runtimeStateChanged: bridge.buildEmitter<import('@/common/config/bondclawRuntimeState').BondClawRuntimeSnapshot>(
    'bondclaw.runtime-state-changed'
  ),
  getWorkspaceSnapshot: bridge.buildProvider<
    import('@/common/config/bondclawWorkspaceSnapshot').BondClawWorkspaceSnapshot,
    import('@/common/config/bondclawWorkspaceSnapshot').BondClawWorkspaceQuery
  >('bondclaw.get-workspace-snapshot'),
};
