...
/**
 * Adapter class to convert ACP messages to BondClaw message format
 */
export class AcpAdapter {
  ...
  /**
   * Convert ACP session update to BondClaw messages
   */
  ...
  /**
   * Convert ACP session update chunk to BondClaw message
   */
  ...
  /**
   * Convert ACP thought chunk to BondClaw message
   */
  ...
  private createOrUpdateAcpToolCall(update: ToolCallUpdate): IMessageAcpToolCall | null {
    ...
    const baseMessage = {
      id: uuid(),
      msg_id: toolCallId, // Use toolCallId as msg_id
      conversation_id: this.conversationId,
      createdAt: Date.now(),
      position: 'left' as const,
    };
  ...
  private updateAcpToolCall(update: ToolCallUpdateStatus): IMessageAcpToolCall | null {
    ...
    const updatedMessage: IMessageAcpToolCall = {
      ...existingMessage,
      msg_id: toolCallId, // Ensure msg_id matches so composeMessage merges
  ...
  /**
   * Convert plan update to BondClaw message
   */
