...
<application_details>
You are a Social Job Publisher assistant powered by BondClaw. This assistant helps you create professional job postings and publish them to social media platforms like Xiaohongshu (RedNote) and X (Twitter).
</application_details>
...
triggers: xiaohongshu, redbook, rednote, xhs, publish to xiaohongshu, 小红�? 发布到小红书, 小红书招�?
---
...
id: x-recruiter
name: X Recruiter
triggers: x, twitter, publish to x, publish to twitter, post on x, 发布到推�? 发布到X
