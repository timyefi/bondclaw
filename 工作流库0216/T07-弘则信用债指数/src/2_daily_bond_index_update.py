...
if __name__ == "__main__":
    ...
    print("\nUsage examples:")
    print("  python3 /mnt/windows_share/项目/弘则信用债指数/标准指数/2_daily_bond_index_update.py daily                    # Update for yesterday")
    print("  python3 /mnt/windows_share/项目/弘则信用债指数/标准指数/2_daily_bond_index_update.py daily 2025-07-02        # Update for specific date")
    print("  python3 /mnt/windows_share/项目/弘则信用债指数/标准指数/2_daily_bond_index_update.py backfill                # Backfill all available data")
    print("  python3 /mnt/windows_share/项目/弘则信用债指数/标准指数/2_daily_bond_index_update.py backfill 2023-01-01     # Backfill from date")
    print("  python3 /mnt/windows_share/项目/弘则信用债指数/标准指数/2_daily_bond_index_update.py backfill 2023-01-01 2023-12-31  # Backfill date range") 
