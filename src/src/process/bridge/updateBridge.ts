...
import { getBondClawAppName, getBondClawRepository } from '@/common/config/bondclawBrand';
import type {
  UpdateCheckResult,
...
const DEFAULT_REPO = getBondClawRepository() || 'https://github.com/timyefi/bondclaw';
const DEFAULT_USER_AGENT = getBondClawAppName();
...
const sanitizeFileName = (name: string): string => {
  ...
  // Avoid empty names.
  return base || `BondClaw-update-${Date.now()}`;
};
